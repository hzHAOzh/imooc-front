<template>
  <div class="bg-white dark:bg-zinc-900 xl:dark:bg-zinc-800 rounded pb-1">
    ...
    <div class="relative w-full rounded cursor-zoom-in group">
      ...
      <!-- 遮罩层，移动端下不显示 -->
      <div
        class="hidden xl:block opacity-0 group-hover:opacity-100 w-full h-full bg-zinc-900/50 absolute top-0 left-0 rounded duration-300"
      >
        <!-- 分享 -->
        ...
        <m-button
          ...
          size="small"
          icon="download"
          iconClass="fill-zinc-900 dark:bg-zinc-200"
        />
        <!-- 全屏 -->
        <m-button
